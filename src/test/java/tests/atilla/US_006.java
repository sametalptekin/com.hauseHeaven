...
public class US_006 {
    ...
    public void TC_002() {
        ...
        if (actualTitle.contains(expectedTitle)) {
            System.out.println("==========SAYFAYA DOĞRUDAN GİRİŞ YAPMA TC_002=========="+"\nSayfa başarılı şekilde açıldı. Title: " + actualTitle);
        } else {
            System.out.println("==========SAYFAYA DOĞRUDAN GİRİŞ YAPMA TC_002==========" +"\nSayfa açılamadı veya title beklendiği gibi değil." + "\nBeklenen: " + expectedTitle +"\nGerçek: " + actualTitle);
    ...
    public void TC_003() {
        ...
        if (actualIlanTitle.contains(expectedilanTitle)) {
            System.out.println("==========ILAN DETAYLARINI GÖRÜNTÜLEME TC_003==========" + "\nSayfa başarılı şekilde açıldı. Title: " + actualIlanTitle);
        } else {
